...
class DecodableAmSgmm2 : public DecodableInterface {
 public:
  DecodableAmSgmm2(const AmSgmm2 &sgmm,
      ...
      gselect_(&gselect), gammar_(&gammar),log_prune_(log_prune), cur_frame_(-1),
 ...
 public:
  DecodableAmSgmm2Scaled(const AmSgmm2 &sgmm,
			 ...
			 const Matrix<BaseFloat>  &gammar,
                         ...
                         BaseFloat scale,
                         Sgmm2PerSpkDerivedVars *spk)
      : DecodableAmSgmm2(sgmm, tm, feats, gselect, gammar, log_prune, spk),
        scale_(scale) {}
  ...
  DecodableAmSgmm2Scaled(const AmSgmm2 &sgmm,
			 ...
			 const Matrix<BaseFloat>  *gammar,
                         ...
                         BaseFloat log_prune,
                         BaseFloat scale)
      : DecodableAmSgmm2(sgmm, tm, feats, gselect, gammar, spk, log_prune),
        scale_(scale) {}
